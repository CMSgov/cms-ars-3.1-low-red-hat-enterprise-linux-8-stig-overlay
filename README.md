# cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay
...
```bash
sudo cinc-auditor exec https://github.com/CMSgov/cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay/archive/<Release version # or Development "main" branch>.tar.gz --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
mkdir profiles
cd profiles
git clone -b <Release version # or Development "main" branch> https://github.com/CMSgov/cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay.git
cinc-auditor archive cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay
...
```
cd cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay
git pull
cd ..
cinc-auditor archive cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay --overwrite
sudo cinc-auditor exec <name of generated archive> --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
To report a bug or feature request, please open an [issue](https://github.com/CMSgov/cms-ars-3.1-low-red-hat-enterprise-linux-8-stig-overlay/issues/new).
